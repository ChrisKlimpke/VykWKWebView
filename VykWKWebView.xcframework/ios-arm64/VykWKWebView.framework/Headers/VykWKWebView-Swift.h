...
#ifndef VYKWKWEBVIEW_SWIFT_H
#define VYKWKWEBVIEW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VykWKWebView",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC12VykWKWebView12VideoCapture")
...
@interface VideoCapture (SWIFT_EXTENSION(VykWKWebView)) <AVCaptureVideoDataOutputSampleBufferDelegate>
